...
Seven lenses to fan out in parallel against a test file.
...
6. Read the appropriate style guideline document, then identify style or convention violations within `<subject>`.
